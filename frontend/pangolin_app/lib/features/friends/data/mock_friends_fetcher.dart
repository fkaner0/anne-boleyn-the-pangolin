  ...
  Future<List<PendingFriend>> fetchPendingFriends(int userId) async {
    ...
    return const [
      PendingFriend(
        ...
        messagePreview: 'Hey! Loved your bedroom wall, the plants are unreal.',
        location: 'London',
        age: 24,
      ),
      PendingFriend(
        ...
        messagePreview: 'Fellow vinyl collector here — we should swap records.',
        location: 'Madrid',
        age: 29,
      ),
      PendingFriend(
        ...
        messagePreview: 'Your photography is gorgeous, what camera do you use?',
        location: 'Singapore',
        age: 22,
      ),
    ];
